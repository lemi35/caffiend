        ...
        <>
            ...
            <div className="coffee-history">
                {Object.keys(globalData).sort((a, b) => b - a).map((utcTime, coffeeIndex) => {
                    ...
                    return (
                        <div className="coffee-card" title={summary} key={coffeeIndex}>
                            <i className="fa-solid fa-mug-hot" />
                             <div className="coffee-card-stat">
                                <p>{coffee.name}</p>
                                <p>Consumed {timeSinceConsume} ago</p>
                                <p>${coffee.cost}</p>
                                <p>Remaining amount in system {remainingAmount}mg / {originalAmount}mg</p>
                            </div>
                        </div>
                    )
                })}
